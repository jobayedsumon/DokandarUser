...
import 'package:dokandar/data/model/response/rider_model.dart';
import 'package:dokandar/data/model/response/trip_model.dart';
...
import 'package:dokandar/helper/rider_type.dart';
...
class RiderController extends GetxController implements GetxService {
    ...
    if (response.statusCode == 200) {
      ...
      if (placeDetails.status == 'OK') {
        AddressModel address0 = AddressModel(
          ...
          contactPersonName: Get.find<LocationController>()
              .getUserAddress()!
              .contactPersonName,
  ...
  void setFromToMarker({required LatLng from, required LatLng to}) async {
    ...
    _duration = await Get.find<OrderController>()
