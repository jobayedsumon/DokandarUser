...
import 'package:dokandar/data/model/response/review_model.dart';
...
import 'package:dokandar/view/screens/chat/widget/image_dialog.dart';
import 'package:dokandar/view/screens/order/widget/delivery_details.dart';
import 'package:dokandar/view/screens/order/widget/offline_info_edit_dialog.dart';
import 'package:dokandar/view/screens/order/widget/order_banner_view.dart';
...
import 'package:dokandar/view/screens/store/widget/review_dialog.dart';
    ...
    return Stack(children: [
      ...
      Column(
        ...
        children: [
          ...
          (order.orderStatus == 'delivered' &&
                  order.orderProof != null &&
                  order.orderProof!.isNotEmpty)
              ? Container(
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor,
                    boxShadow: [
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, index) {
                            return Padding(
                              ...
                              child: InkWell(
                                onTap: () => openDialog(context,
                                    '${Get.find<SplashController>().configModel!.baseUrls!.orderAttachmentUrl}/${order.orderProof![index]}'),
                                child: Center(
                                    child: ClipRRect(
                                  borderRadius: BorderRadius.circular(
                                      Dimensions.radiusSmall),
                          ...
                          (order.orderStatus != 'delivered' &&
                              ...
                              ? Row(children: [
                                  ...
                                  InkWell(
                                    ...
                                    child: Image.asset(Images.phoneOrderDetails,
                                        height: 20, width: 20),
                                  ),
                                ])
                              : const SizedBox(),
          ...
          SizedBox(
              height:
                  order.deliveryMan != null ? Dimensions.paddingSizeLarge : 0),
          ...
          Container(
            ...
            child:
              ...
              (parcel && order.parcelCategory == null)
                  ? Text('no_parcel_category_data_found'.tr,
                      style: robotoMedium)
                  : (!parcel && order.store == null)
                      ? Center(
                          child: Padding(
