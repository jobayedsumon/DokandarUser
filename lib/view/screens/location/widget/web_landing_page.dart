...
import 'package:dokandar/view/base/custom_loader.dart';
...
import 'package:dokandar/view/screens/location/widget/landing_card.dart';
import 'package:dokandar/view/screens/location/widget/registration_card.dart';
import 'package:dokandar/view/screens/location/widget/web_landing_page_shimmer_view.dart';
    ...
    for (int index = 0;
      ...
      chooseUsList.add(Expanded(
        ...
        Expanded(
          ...
          title:
              splashController.landingModel!.specialCriterias![index].title ??
                  '',
        )),
        SizedBox(
            width: index !=
