...
class DateConverter {
  ...
  static String dateTimeStringToDateTimeWithMonths(
      String dateTime, int months) {
    return DateFormat('dd MMM yyyy  ${_timeFormatter()}').format(
        DateFormat('yyyy-MM-dd HH:mm:ss')
            .parse(dateTime)
            .add(Duration(days: (30 * months) + 5)));
  }
