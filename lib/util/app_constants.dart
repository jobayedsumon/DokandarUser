...
class AppConstants {
  ...
  static const String webHostedUrl = 'https://dokandar.online';
  ...
  static const String updateGiftAddress =
      '/api/v1/customer/address/update-gift-address';
  ...
  static const String investmentPackagesUri =
